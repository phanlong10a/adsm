...
const API_PATH_DOWNLOAD_EXCEL = `${ConstantList.API_ENPOINT}/api/download/excel`;

export const downloadExcel = searchObject => {
    var url = `${API_PATH_DOWNLOAD_EXCEL}/health-organization`;
