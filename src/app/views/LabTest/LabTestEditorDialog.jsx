...
class LabTestEditorDialog extends React.Component {
  ...
  handleFormSubmit = (values) => {
    ...
    // obj.normalStringResult = values.normalStringResult;
    // obj.labTestType = values.labTestType;
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <span className="mb-20 text-white" > {(id ? t('general.button.edit') : t('general.button.add')) + " " + "Xét nghiệm"} </span>
          ...
          initialValues={
            {
              ...
              averageNumberResult: averageNumberResult ? averageNumberResult : null,
              }
          }
...
// labTestType: labTestType ? labTestType : null,
// normalStringResult: normalStringResult ? normalStringResult : null
